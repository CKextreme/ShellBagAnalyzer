...
\begin{document}
	...
	\input{part/aufgabe_motivation.tex}
	%Zielsetzung, Motivation
	
	% Grundlagen ShellBags
	\input{part/grundlagen.tex}
	%Shellbags Eintrag, Speicherort,...
	
	%Qualitätsanforderungen
	\input{part/anforderungen.tex}

	% Implementierung
	\input{part/implementierung.tex}
	
	% Bedienungsanleitung
	\input{part/bedienung.tex}
	
	% Validierung
	\input{part/validierung.tex}
	
	% Diskussion
	\input{part/diskussion.tex}
	
	% Ergebnisse und Diskussion
	\input{part/fazit.tex}
	\newpage
	% Ausblick
	\input{part/ausblick.tex}
	\newpage
	% Literatur
